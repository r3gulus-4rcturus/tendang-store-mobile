...
class MyHomePage extends StatelessWidget {
    MyHomePage({super.key}); //sudah ada pada code sebelumnya
     ...
     final List<ItemHomepage> items = [
        ItemHomepage("All Products", Icons.public, Colors.blue),
        ItemHomepage("My Products", Icons.create, Colors.green),
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "Tendang Store" dengan teks putih dan tebal.
        title: const Text(
          'Tendang Store',
          style: TextStyle(
            color: Colors.white,
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Selamat datang di Tendang Store',
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 18.0,
                      ),
